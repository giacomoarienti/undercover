            ...
            <div class="col-3 p-0 d-none d-md-flex flex-column justify-content-start align-items-start">
                <form class="w-100" action="{{ route('products.index') }}" method="GET">
                    ...
                    <div class="container d-flex flex-column justify-content-start align-items-start">
                        <div class="container d-flex flex-row flex-wrap justify-content-between align-items-center border-bottom">
                            ...
                            <a href="{{ route('products.show', $product->slug) }}" class="text-decoration-none h-100">
                                <div class="card h-100">
                                    <div class="card-body d-flex flex-column justify-content-between align-items-start h-100">
                                        ...
                                        <img class="img-thumbnail bg-white h-100 object-fit-contain"
                                             src="{{$product->getFirstMediaUrl('images', 'thumb')}}" alt=""/>
                                        <p class="align-self-end card-text text-muted text-end m-2">{{$product->price . '€'}}</p>
                                        <div class="d-flex flex-row align-self-center flex-wrap justify-content-center bg-secondary-subtle border rounded-pill ms-2 me-2">
